...
const FUNDS = [
  ...
  { id: 'KKP SEMICON-H', type: 'feeder', sector: 'Technology', name: 'กองทุนเปิดเคเคพี เซมิคอนดักเตอร์ เฮดจ์', amc: 'KKP', amcFull: 'เกียรตินาคินภัทร (KKPAM)', nav: 27.9102, chg1d: -0.85, ret1m: -9.62, perf: 84.47, ret3y: 39.92, risk: 7, div: 0.0, aum: 2400, master: 'iShares Semiconductor ETF', holdings: [['TSMC', 12.0], ['NVIDIA', 9.5], ['Broadcom', 7.2], ['Qualcomm', 5.0], ['AMD', 4.5]], starred: false },
  { id: 'SCBSEMI(A)', type: 'feeder', sector: 'Technology', name: 'กองทุนเปิดไทยพาณิชย์ Semiconductor (ชนิดสะสมมูลค่า)', amc: 'SCB', amcFull: 'ไทยพาณิชย์ (SCBAM)', nav: 33.9117, chg1d: -0.65, ret1m: -7.61, perf: 92.09, ret3y: 47.10, risk: 7, div: 0.0, aum: 15200, master: 'VanEck Semiconductor ETF (SMH)', holdings: [['NVIDIA', 20.5], ['TSMC', 13.2], ['Broadcom', 7.8], ['ASML', 6.2], ['AMD', 5.1]], starred: true },
  { id: 'SCBKEQTG', type: 'feeder', sector: 'Technology', name: 'กองทุนเปิดไทยพาณิชย์หุ้นเกาหลี', amc: 'SCB', amcFull: 'ไทยพาณิชย์ (SCBAM)', nav: 23.7286, chg1d: -0.12, ret1m: -2.22, perf: 117.44, ret3y: 36.31, risk: 6, div: 0.0, aum: 10800, master: 'iShares MSCI South Korea ETF', holdings: [['Samsung Electronics', 24.9], ['SK Hynix', 11.2], ['Hyundai Motor', 4.1], ['KB Financial', 3.4], ['SK Square', 2.8]], starred: true },
